...
flags.DEFINE_string('train_data', '/home/custom/train_ntire18_new_rw.tfrecord', 'path of the training dataset')
...
flags.DEFINE_string('valid_data', '/home/custom/strain_ntire18_new_rw.tfrecord', 'path of the validation dataset')
